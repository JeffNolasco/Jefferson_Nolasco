...
public class ClienteService {
    ...
    @Transactional // en operaciones solo de lectura no necesito transacciones
    public Cliente create(Cliente cliente) {
        ...
        if (clienteTmp == null) {
            ...
            throw new RuntimeException("Cliente ya existe"); //se usa RuntimeException debido al @Transactional
        }
    }
    ...
    public Cliente update(Cliente cliente) {
        ...
        if (clienteOpt.isPresent()) { //si es que existe el cliente
